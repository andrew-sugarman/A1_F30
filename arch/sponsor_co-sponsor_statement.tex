...
% Formal coursework at the Pennsylvania State University for Andrew will include his
% required and elective courses towards his Ph.D. in Bioinformatics and Genomics.
% These include courses in human genetics (ANTH 460), applied bioinformatics (BMMB
% 852 and 554), genomic technologies (MCIBS 551), python programming (BGEN 597), population
% genetics (BIOL 428), and ethics, rigor, and reproducibility (MCIBS 591). In
% addition, Kyle regularly attends the Bioinformatics and Genomics Colloquium
% Series (BGEN 590) which covers a variety of emerging topics in bioinformatics
% and genomics. Beyond these required courses, Kyle has taken additional courses
% to facilitate his research and the work planned in this proposal. These courses
% include Statistical Genomics (Stat 555) and Theory of Statistics (STAT 513). To
% date, Kyle has successfully completed all of his formal coursework.

% Complementing formal course work, Kyle regularly attends and has presented his
% work at the Penn State One Health Microbiome Center Seminar Series which brings
% together faculty, staff, and trainees from across the university. This series
% has given Kyle valuable experience presenting his work to a large audience and
% has catalyzed mentoring opportunities across the university. To provide Kyle
% with further experience presenting his work, Kyle has and will continue to
% present every other month as part of regularly scheduled lab meetings. Finally,
% to provide further experience with presentation and to gain exposure to current
% trends in statistics and bioinformatics research, Kyle will regularly attend and
% contribute to conferences, meetings, and workshops relevant to his thesis work
% and to his long-term career plans. Such venues include the International Society
% for Computational Biology (ISMB, annual) and Joint Statistical Meeting (JSM, annual).
